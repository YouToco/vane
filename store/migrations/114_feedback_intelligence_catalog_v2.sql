-- 114: expose canonical delivery feedback through the generic intelligence
...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION '114: intelligence reader role graph is unsafe';
    END IF;
END $$;
-- +goose StatementEnd
...
BEGIN
    IF EXISTS (
        ...
        RAISE EXCEPTION
            '114: refusing downgrade while feedback intelligence audits exist';
    END IF;
END $$;
-- +goose StatementEnd
