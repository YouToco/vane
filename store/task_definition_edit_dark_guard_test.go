...
func taskDefinitionEditCoordinatorStoreCalls(file *ast.File) (map[token.Pos]struct{}, error) {
	expectations := []taskDefinitionEditStoreCallExpectation{
		...
		{"LoadTaskDefinitionEditOperation", "Execute", 1},
...
func taskDefinitionEditV3CoordinatorStoreCalls(file *ast.File) (map[token.Pos]struct{}, error) {
	expectations := []taskDefinitionEditStoreCallExpectation{
		...
		{"ListStaleResearchTaskDefinitionEditTenantIDsV3", "RecoverStaleOnceV3", 1},
...
func taskDefinitionEditStoreMutationGraphExpectations() []taskDefinitionEditStoreCallExpectation {
	return []taskDefinitionEditStoreCallExpectation{
		...
		{"acquireTaskDefinitionEditOperationProtocol", "AcquireResearchTaskDefinitionEditOperationV3", 1},
		...
		{"blockInvalidTaskDefinitionEditCheckpoint", "checkpointResearchTaskDefinitionEditV3", 1},
		...
		{"terminateTaskDefinitionEditTx", "CompleteResearchTaskDefinitionEditOperationV3", 1},
		{"terminateTaskDefinitionEditTx", "BlockResearchTaskDefinitionEditOperationV3", 1},
		{"insertTaskDefinitionEditReceiptForTerminal", "expirePendingTaskDefinitionEdit", 1},
		{"insertTaskDefinitionEditReceiptForTerminal", "expireTaskDefinitionEditDuringAcquire", 1},
		{"insertTaskDefinitionEditReceiptForTerminal", "startAndTerminateTaskDefinitionEditDuringAcquire", 1},
		...
		{"beginTaskDefinitionEditTx", "ListStaleResearchTaskDefinitionEditOperationsV3", 1},
...
func taskDefinitionEditStoreProviderFunctionSymbols(
	...
	return map[string]map[string]struct{}{
		...
		filepath.Clean(filepath.Join(storeDir, "task_definition_edit_v3.go")): taskDefinitionEditStoreMethodSet([]string{
			...
			"loadCurrentResearchPreparedScheduleV3Tx",
			...
			"verifyResearchTaskDefinitionEditAuthorityV3",
			...
			"verifyCommittedResearchTaskDefinitionEditV3",
			"CommitResearchTaskDefinitionEditDefinitionV3",
			"researchTaskDefinitionEditCompletedScheduleExactV3",
