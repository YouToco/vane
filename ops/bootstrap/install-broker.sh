...
install -o root -g root -m 0755 "$broker_dir/broker-shim.sh" "$install_root/libexec/vane-broker"
install -o root -g root -m 0644 "$broker_dir/controller.py" "$install_root/libexec/controller.py"
install -o root -g root -m 0755 "$broker_dir/production_handler.py" "$install_root/libexec/production_handler.py"
install -o root -g root -m 0755 "$broker_dir/run-production-handler.sh" "$install_root/libexec/run-production-handler.sh"
